...
public sealed class SGSModV3Character : ModCharacterTemplate<SGSModV3CardPool, SGSModV3RelicPool, SGSModV3PotionPool>
{
    ...
    private const string CharacterScenePath = $"{SceneRoot}/SGSModV3_character.tscn";
    private const string EnergyCounterScenePath = $"{SceneRoot}/SGSModV3_energy_counter.tscn";
    private const string MerchantScenePath = $"{SceneRoot}/SGSModV3_merchant.tscn";
    private const string RestSiteScenePath = $"{SceneRoot}/SGSModV3_rest_site.tscn";
    private const string CharacterSelectBgScenePath = $"{SceneRoot}/SGSModV3_character_select_bg.tscn";
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            // 人物头像路径。
            IconTexturePath: $"{ImageRoot}/SGSModV3_character_icon.png",
            // 人物头像轮廓。
            IconOutlineTexturePath: $"{ImageRoot}/SGSModV3_character_icon_outline.png",
            // 人物选择背景。
            CharacterSelectBgPath: CharacterSelectBgScenePath,
            // 人物选择图标。
            CharacterSelectIconPath: $"{ImageRoot}/SGSModV3_character_select.png",
            // 人物选择图标-锁定状态。
            CharacterSelectLockedIconPath: $"{ImageRoot}/SGSModV3_character_select_locked.png",
            // 地图上的角色标记图标、表情轮盘上的角色头像。
            MapMarkerPath: $"{ImageRoot}/SGSModV3_map_marker.png"));
